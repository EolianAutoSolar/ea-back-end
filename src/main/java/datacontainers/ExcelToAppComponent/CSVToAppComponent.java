package datacontainers.ExcelToAppComponent;
...
public class CSVToAppComponent {
    ...
    public static List<DataContainer> CSVs_to_AppComponents(String directory) throws Exception{
        LinkedList<DataContainer> list = new LinkedList<>();
        ...
        for (String comp : components){
            ...
            list.add(new DataContainer(comp.split("\\.")[0], min, max, params));
        }
