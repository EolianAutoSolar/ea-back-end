...
public class WirelessSender extends WirelessService{
    ...
    public WirelessSender(List<DataContainer> components, String XBEE_PORT, boolean encrypt) throws Exception{
     ...
     * @throws Exception
     */
    public WirelessSender(List<DataContainer> components, XbeeReceiver xbeeReceiver, boolean encrypt) throws Exception{
        super(components, encrypt);
        this.bytesToSendNow = new ArrayList<>();
    ...
    @Override
    public void serve(DataContainer c) {
