...
import services.WirelessService.PresentationLayer.Packages.Message;
...
public class WirelessReceiver extends WirelessService{
    ...
    // To save memory
    char currentHeader;
    public ArrayList<DataContainer> appCompUpdated;

    public WirelessReceiver(List<DataContainer> components, String XBEE_PORT, boolean encrypt, List<Service> otherServices) throws Exception {
     ...
     * @throws Exception
     */
    public WirelessReceiver(List<DataContainer> components, boolean encrypt, List<Service> otherServices) throws Exception {
        super(components, encrypt);
        this.appCompUpdated = new ArrayList<>();
