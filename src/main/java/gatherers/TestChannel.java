...
public class TestChannel extends Gatherer{
     ...
     */
    public TestChannel(List<DataContainer> myComponentList, List<Service> myServices) {
     ...
     * @param myServices Services to inform to whenever an AppComponents get updated
     */
    public TestChannel(List<DataContainer> myComponentList, List<Service> myServices, String[] componentsIds) {
