...
public class I2C extends Gatherer{
    private I2CBus bus;
    private I2CDevice arduino0;
    public DataContainer arduino1;
    private int currentRegister;
    public DataContainer bms;
    public DataContainer bms_temp;
    public DataContainer bms_volt;
    public DataContainer mppt1;
    public DataContainer mppt2;
    public DataContainer mppt3;
    public DataContainer mppt4;
    public DataContainer kelly_der;
    public DataContainer kelly_izq;
    public DataContainer main_data;
